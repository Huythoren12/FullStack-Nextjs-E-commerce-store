"use client"
import { internalGroqTypeReferenceTo, Product, SanityImageAsset, SanityImageCrop, SanityImageHotspot } from '@/sanity.types';
...
const ImageView = ({images=[],isStock,product}:Props) => {
