        ...
        <div className="w-full md:w-1/2 flex flex-col gap-5">
            ...
            <div className=" space-y-2 border-t border-b border-gray-200 py-5">
                <PriceView 
                 ...
                 <p className={` px-4 py-1.5 text-sm text-center font-semibold inline-block rounded-lg ${product?.stock ===0 ?" bg-red-100 text-red-100":"text-green-600 ng-green-100"}`}>
                ...
                <div className ="border border-lightColor/25 border-b p-3 flex items-center gap-2.5">
                    ...
                    <div>
                        ...
                        <p className="text-sm text-gray-500 underline underline-offset-2">
                            Enter your portal code for Delivery Availability
                        </p>
                    </div>
                </div>
            
                <div className="border border-lightColor/25 border-t-0 p-3 flex items-center gap-2.5">
